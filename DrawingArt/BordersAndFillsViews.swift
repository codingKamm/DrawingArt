...
struct BordersAndFillsViews: View {
    var body: some View {
        VStack{
            ...
            Capsule() // ImagePaint will automatically keep tiling its image until it has filled its area – it can work with backgrounds, strokes, borders, and fills of any size.
